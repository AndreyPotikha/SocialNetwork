...
import tranning.compare.AppleSweetnessComparator;
...
public class Apple implements Fruit, Comparable<Apple>{
    ...
    public static void main(String[] args) {
        ...
        Apple apple3 = new Apple(8.0, 5.0);
        Apple apple4 = new Apple(4.0, 3.0);
        Apple apple5 = new Apple(1.0, 8.0);
        Apple apple6 = new Apple(15.0, 7.0);
        ...
        apples.sort(new AppleSweetnessComparator().reversed());
        System.out.println(apples);
    }
}
